 ...
 * Descriptors are special computer-readable structures which the host requests
 * upon device enumeration, to determine the device's capabilities and
 * functions.
 */
...
const USB_Descriptor_HIDReport_Datatype_t PROGMEM JoystickReport[] = {
    ...
    // that we sent. The Switch requires us to have these descriptors
    // available.
...
const USB_Descriptor_String_t PROGMEM ManufacturerString
  = USB_STRING_DESCRIPTOR (L"HORI CO.,LTD.");
...
const USB_Descriptor_String_t PROGMEM ProductString
  = USB_STRING_DESCRIPTOR (L"POKKEN CONTROLLER");
